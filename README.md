...
[see it running live](https://haroldathome.com/the-long-take) — and
[component 17](components/17-broadsheet/) replaces HA's frontend entirely
with your own app. It starts with a £5 ESP32 and a light that turns
itself on.*
...
**The advanced tier** — four components that build on the core. Do that
...
| 17 | [Broadsheet](components/17-broadsheet/) | The graduation: keep HA as the engine room and put your own app in front of the household — an open-source magazine-style frontend ([Broadsheet](https://github.com/alfiedennen/broadsheet)) that adapts to whatever you've built. Two-minute add-on install | Everything |
...
components/   17 self-contained components — 13 core + 4 advanced-tier
