...
- **Keep the master toggle on a dashboard.** `input_boolean.cinema_auto_scene` exists so the behaviour can be paused for ironing/background-telly days without hunting down and disabling the automation itself.
